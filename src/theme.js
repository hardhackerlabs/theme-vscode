...
function getTheme(name, colorConfig, controlsOpt = {}) {
  ...
  return {
    ...
    colors: {
      ...
      "editor.lineHighlightBackground": colors.hoverBackground,
      "editor.lineHighlightBorder": colors.transparent,
      "editor.hoverHighlightBackground": originColors.blue.clone().setAlpha(0.2).toHex8String(),
      "editor.findMatchBackground": originColors.cyan.clone().setAlpha(0.2).toHex8String(),
      "editor.findMatchBorder": originColors.cyan.clone().setAlpha(0.8).toHex8String(),
      "editor.findMatchHighlightBackground": originColors.cyan.clone().setAlpha(0.2).toHex8String(),
      "editor.findRangeHighlightBackground": originColors.cyan.clone().setAlpha(0.2).toHex8String(),
      ...
      "minimapGutter.addedBackground": originColors.green.clone().setAlpha(0.6).toHex8String(),
      "minimapGutter.modifiedBackground": originColors.blue.clone().saturate(100).setAlpha(0.6).toHex8String(),

      "editorOverviewRuler.findMatchForeground": originColors.cyan.clone().setAlpha(0.6).toHex8String(),
      "editorOverviewRuler.addedForeground": originColors.green.clone().setAlpha(0.6).toHex8String(),
      ...
      "sideBar.background": controls.highContrast ? colors.highContrastBackground : colors.background,
      ...
      "list.focusBackground": colors.hoverBackground,
      "list.dropBackground": colors.hoverBackground,
      ...
      "tab.inactiveBackground": controls.highContrast ? colors.highContrastBackground : colors.background,
      "tab.inactiveForeground": colors.secondaryText,
      "tab.activeBorder": controls.highContrast ? colors.background : colors.themePrimary,
      ...
      "editorGroup.dropBackground": colors.hoverBackground,
      "editorGroupHeader.tabsBackground": controls.highContrast ? colors.highContrastBackground : colors.background,
      "editorGroupHeader.tabsBorder": controls.highContrast ? colors.highlightBackground : colors.transparent,

      "statusBar.background": controls.highContrast ? colors.highContrastBackground : colors.background,
      ...
      "panel.background": controls.highContrast ? colors.highContrastBackground : colors.background,
